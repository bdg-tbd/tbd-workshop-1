...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "hubert-pogorzelski": "hpogorzelski0@gmail.com",<br/>  "jan-magnuszewski": "01172006@pw.edu.pl",<br/>  "marek-wiewiorka": "marek.wiewiorka@gmail.com"<br/>}</pre> | no |
