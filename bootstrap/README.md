...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "anna-schafer": "01169233@pw.edu.pl",<br/>  "mikolaj-szawerda": "mikolaj.szawerda@gmail.com",<br/>  "patryk-gryz": "pfgryz@gmail.com"<br/>}</pre> | no |
