...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "bartlomiej-scisel": "vermish9@gmail.com",<br/>  "jakub-winter": "jakubwinter01@gmail.com",<br/>  "marek-wiewiorka": "marek.wiewiorka@gmail.com",<br/>  "mariusz-paluch": "mariusz.paluch2001@gmail.com"<br/>}</pre> | no |
