...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br>  "aleksander-swiniarski": "alexsersinoes@gmail.com",<br>  "magdalena-kalinska": "madziakalinska2401@gmail.com",<br>  "marek-wiewiorka": "marek.wiewiorka@gmail.com",<br>  "marta-sobol": "m.sob278@gmail.com"<br>}</pre> | no |
