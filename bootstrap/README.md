...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "izabela-lengiewicz": "izabela.leng@gmail.com",<br/>  "katarzyna-witowska": "katarzyna.witowska8@gmail.com",<br/>  "katarzyna-zaleska": "kzaleska416@gmail.com",<br/>  "marek-wiewiorka": "marek.wiewiorka@gmail.com"<br/>}</pre> | no |
