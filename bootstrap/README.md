...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "dpalyska": "01169221@pw.edu.pl",<br/>  "filip-kiernozek": "kiernozek16@gmail.com",<br/>  "michal-laskowski": "01158164@pw.edu.pl"<br/>}</pre> | no |
