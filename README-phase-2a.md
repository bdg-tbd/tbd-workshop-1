...
3. In your `main.tf` (in the root module) from the phase 1 change each module `source` reference from the repo relative path to a github repo tag `v1.0.33` , e.g.:
```hcl
