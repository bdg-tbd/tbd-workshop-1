...
| <a name="input_preeemptible_worker_count"></a> [preeemptible\_worker\_count](#input\_preeemptible\_worker\_count) | Number of preemptible worker nodes for Dataproc cluster | `number` | `1` | no |
...
| <a name="input_worker_count"></a> [worker\_count](#input\_worker\_count) | Number of worker nodes for Dataproc cluster | `number` | `2` | no |
