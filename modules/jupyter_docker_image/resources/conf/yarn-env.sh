...
export YARN_TIMELINESERVER_OPTS="${YARN_TIMELINESERVER_OPTS} -Djava.util.logging.config.file=/etc/hadoop/conf/yarn-timelineserver.logging.properties"

# Add Dataproc common libs (e.g. connectors) to YARN class path.
# (required for Hadoop 3: https://jira.apache.org/jira/browse/HADOOP-11656).
export HADOOP_CLASSPATH=${HADOOP_CLASSPATH}:/usr/local/share/google/dataproc/lib/*
