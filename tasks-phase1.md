...
4. Create new git branch and:
   ...
   **_place the screenshot from GA after succesfull application of release_**
   Unfortunately we could not get a release to pass. The release workflow was always stuck on the quota limit of 12, and 6 CPUs used, allocating 8 was not possible.

Error reference:
   ```
   Error: Error waiting to create Environment: Error waiting for Creating Environment: Error code 7, message: CREATE operation failed. Could not trigger cluster creation: Insufficient project quota to satisfy request: resource "CPUS_ALL_REGIONS": request requires '8.0' and is short '2.0'. project has a quota of '12.0' with '6.0' available. View and manage quotas at https://console.cloud.google.com/iam-admin/quotas?usage=USED&project=tbd-2025z-319021.
   ```
...
### Diagram
![./doc/figures/module-composer-diagram.png]
